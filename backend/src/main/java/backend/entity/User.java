...
public class User{
    ...
    private String typeOfUser; //korisnik - nuzno za security
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(id, user.id) && Objects.equals(username, user.username) && Objects.equals(email, user.email) && Objects.equals(password, user.password) &&  Objects.equals(homeAdress, user.homeAdress);
    }
